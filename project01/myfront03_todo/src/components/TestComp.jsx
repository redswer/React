...
function reducer(state, action) {
    ...
    // action.type 이 'Increase'면 state 값에 data 더해서 return 하고 return 값이 새로운 상태값(state)이 됨
    // => action.type 이 'Increase' 면 state + action.data 를, 'Decrease'면 state - data 를 리턴
    switch (action.type) {
